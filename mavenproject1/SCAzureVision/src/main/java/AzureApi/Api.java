...
public class Api extends HttpServlet {
    ...
    private String connectionString = "DefaultEndpointsProtocol=https;AccountName=jvaleriom1999;AccountKey=63Bu1R2KeO68XTDiDpsxRpmEfx920N612QkQ8w8Ww/izqBJuZ0ibRKj+sxdgJEwazBHkUzhBUDZ5boND+/XlHA==;EndpointSuffix=core.windows.net";
    private String visionAPIKey = "ea7a443efda140298dc3915a5e52e54c";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (ListBlobItem photo : images.listBlobs()) {
            ...
            // get the blob URL
            azureImage.put("url", imageBlob.getUri().toString().replace(".blob.core.windows.net/img-valerio/", ".blob.core.windows.net/thumbnails/"));
                ...
                if (metadata.containsKey("tags")) {
                    ...
                    if (search != null) {
                        for (Object tag : imageMetadata.getJSONArray("tags")) {
                            if (((String) tag).toLowerCase().equals(search.toLowerCase())) {
                                match = true;
                                break;
                            }
                        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Part> fileParts = request.getParts().stream().filter(part -> "img-valerio".equals(part.getName())).collect(Collectors.toList());
